...
//This class will create a flag that will help the player advance to the next level
public class Flag extends GameObject{
	...
	//Create a new flag
	public Flag(int x, int y, int ObjectId) {
	...
	public void render(Graphics g, Camera cam) {
		g.drawImage(img.flag,(int) x, (int) y, width, height,null);
	}
